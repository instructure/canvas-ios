...
extension DataSeeder {
    ...
    public func enrollDesigner(_ designer: DSUser, in course: DSCourse, state: EnrollmentState = .active) {
        self.enrollUsers([designer], in: course, type: .DesignerEnrollment, state: state)
    }
