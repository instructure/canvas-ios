...
public class ConferencesHelper: BaseHelper {
    ...
    public static func createConference(
            ...
            description: String = "This is a conference description") -> DSConference {
        return seeder.createConference(course: course, title: title, duration: duration, description: description)
    }
}
