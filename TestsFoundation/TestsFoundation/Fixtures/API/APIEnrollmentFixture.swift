...
extension APIEnrollment {
    public static func make(
        ...
        end_at: Date? = nil,
        grades: Grades? = nil,
        computed_current_score: Double? = 74.38,
        computed_final_score: Double? = 49.03,
        computed_current_grade: String? = nil,
        computed_final_grade: String? = nil,
        multiple_grading_periods_enabled: Bool? = true,
        totals_for_all_grading_periods_option: Bool? = true,
        current_grading_period_id: String? = "1",
        current_period_computed_current_score: Double? = 74.38,
        current_period_computed_final_score: Double? = 49.03,
