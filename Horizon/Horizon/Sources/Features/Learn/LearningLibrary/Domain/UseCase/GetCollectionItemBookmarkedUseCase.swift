...
final class GetCollectionItemBookmarkedUseCase: APIUseCase {
    ...
    public var request: GetHLearningLibraryItemRequest { GetHLearningLibraryItemRequest(bookmarkedOnly: true) }

    var scope: Scope {
        .where(
            #keyPath(CDHLearningLibraryCollectionItem.isBookmarked),
            equals: true,
