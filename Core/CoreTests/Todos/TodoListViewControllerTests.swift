...
class TodoListViewControllerTests: CoreTestCase {
    ...
    func testLayout() {
        ...
        XCTAssertEqual(navigation.navigationBar.barTintColor?.difference(to: Brand.shared.navBackground), 0)
        ...
        XCTAssertEqual(cell?.contextLabel.textColor.difference(to: UIColor(hexString: "#f00")!.ensureContrast()), 0)
