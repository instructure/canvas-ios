...
class CalendarViewControllerTests: CoreTestCase, CalendarViewControllerDelegate {
    ...
    func testLayout() {
        ...
        delegate?.pageViewController?(controller.daysPageController, willTransitionTo: [prev!, controller.days])
        ...
        delegate?.pageViewController?(controller.daysPageController, willTransitionTo: [controller.days, next!])
