...
final class CollapseButtonExpandedStateTests: CoreTestCase {
    ...
    private var testee: AUI.CollapseButtonExpandedState!
    ...
    func test_init_whenExpandedTrue_shouldSetIsExpandedToTrue() {
        testee = AUI.CollapseButtonExpandedState(isExpanded: true)

        XCTAssertContains(testee.a11yValue, "Expanded")
    }

    func test_init_whenExpandedFalse_shouldSetIsExpandedToFalse() {
        testee = AUI.CollapseButtonExpandedState(isExpanded: false)
    ...
    func test_a11yValue_whenExpanded_shouldReturnExpandedValue() {
        ...
        XCTAssertEqual(
            testee.a11yValue,
            AUI.CollapseButtonExpandedState.expanded.a11yValue
        )
    }
    ...
    func test_a11yValue_whenCollapsed_shouldReturnCollapsedValue() {
        ...
        XCTAssertEqual(
            testee.a11yValue,
            AUI.CollapseButtonExpandedState.collapsed.a11yValue
        )
    }
    ...
    func test_a11yHint_whenExpanded_shouldReturnExpandedHint() {
        ...
        XCTAssertEqual(
            testee.a11yHint,
            AUI.CollapseButtonExpandedState.expanded.a11yHint
        )
    }
    ...
    func test_a11yHint_whenCollapsed_shouldReturnCollapsedHint() {
        ...
        XCTAssertEqual(
            testee.a11yHint,
            AUI.CollapseButtonExpandedState.collapsed.a11yHint
        )
    }
    ...
    func test_a11yActionLabel_whenExpanded_shouldReturnExpandedActionLabel() {
        ...
        XCTAssertEqual(
            ...
            AUI.CollapseButtonExpandedState.expanded.a11yActionLabel
        )
    }
    ...
    func test_a11yActionLabel_whenCollapsed_shouldReturnCollapsedActionLabel() {
        ...
        XCTAssertEqual(
            testee.a11yActionLabel,
            AUI.CollapseButtonExpandedState.collapsed.a11yActionLabel
        )
    }
    ...
    func test_expanded_shouldReturnCorrectStrings() {
        let expanded = AUI.CollapseButtonExpandedState.expanded
    ...
    func test_collapsed_shouldReturnCorrectStrings() {
        let collapsed = AUI.CollapseButtonExpandedState.collapsed
