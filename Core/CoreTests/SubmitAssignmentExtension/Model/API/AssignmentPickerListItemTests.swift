...
class AssignmentPickerListItemTests: XCTest {

    func testAssignmentCompatibleURLs() {
        var assignment = AssignmentPickerListItem(id: "1", name: "1", allowedExtensions: ["pdf", "jpg"])
        XCTAssertTrue(assignment.isFileAllowed(URL(string: "/file.jpg")!))
        XCTAssertFalse(assignment.isFileAllowed(URL(string: "/file.png")!))

        assignment = AssignmentPickerListItem(id: "1", name: "1", allowedExtensions: [])
