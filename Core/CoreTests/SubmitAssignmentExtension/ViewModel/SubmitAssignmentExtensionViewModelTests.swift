...
class SubmitAssignmentExtensionViewModelTests: CoreTestCase {
    ...
    func testAssignmentButtonTitleUpdates() {
        ...
        testee.assignmentPickerViewModel.assignmentSelected(.init(id: "1", name: "selected assignment", allowedExtensions: []))
    ...
    func testCourseSwitchResetsSelectedAssignment() {
        ...
        testee.assignmentPickerViewModel.assignmentSelected(.init(id: "random AssignmentID", name: "assignment", allowedExtensions: []))
    ...
    func testReportsSubmitToAnalytics() {
        ...
        testee.assignmentPickerViewModel.assignmentSelected(.init(id: "", name: "", allowedExtensions: []))
        let analyticsHandler = MockAnalyticsHandler()
        Analytics.shared.handler = analyticsHandler
        XCTAssertEqual(analyticsHandler.loggedEventCount, 0)
