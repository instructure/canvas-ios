...
class APIAccountNotificationTests: XCTestCase {
    ...
    func testGetAccountNotificationRequest() {
        XCTAssertEqual(GetAccountNotificationRequest(id: "1").method, .get)
        XCTAssertEqual(GetAccountNotificationRequest(id: "1").path, "accounts/self/account_notifications/1")
    }

    func testDeleteAccountNotificationRequest() {
        XCTAssertEqual(DeleteAccountNotificationRequest(id: "1").method, .delete)
        XCTAssertEqual(DeleteAccountNotificationRequest(id: "1").path, "accounts/self/account_notifications/1")
    }
}
