...
final class DeleteCalendarEventRequestTests: XCTestCase {

    func testProperties() {
        let testee = DeleteCalendarEventRequest(id: "42", body: .make())
    ...
    func testDecodingSingleEvent() throws {
        let testee = DeleteCalendarEventRequest(id: "", body: .make())
