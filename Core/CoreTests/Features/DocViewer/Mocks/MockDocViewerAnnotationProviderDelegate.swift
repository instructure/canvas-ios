...
class MockDocViewerAnnotationProviderDelegate: DocViewerAnnotationProviderDelegate {
    enum Event: Equatable {
        case exceededLimit(APIDocViewerAnnotation)
        case failedToSave
    ...
    func annotationDidExceedLimit(annotation: APIDocViewerAnnotation) {
        callStack.append(.exceededLimit(annotation))
    }
