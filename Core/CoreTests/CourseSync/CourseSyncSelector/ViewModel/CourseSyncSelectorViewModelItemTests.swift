...
class CourseSyncSelectorViewModelItemTests: XCTestCase {
    ...
    func testFilesTabCollapsion() {
        let file = CourseSyncSelectorEntry.File.make(id: "0", name: "test.txt")
    ...
    func testFileItemMapping() {
        var data = CourseSyncSelectorEntry.File.make(id: "1", name: "testFile")
        var testee = data.makeViewModelItem()
    ...
    func testSelectionForwardedToInteractor() {
        let data = CourseSyncSelectorEntry(name: "test",
                                           ...
                                           files: [
                                            .make(id: "0", name: "test.txt", selectionState: .deselected),
                                            .make(id: "1", name: "test1.txt", selectionState: .deselected),
                                           ],
                                           isCollapsed: false,
