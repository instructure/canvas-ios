...
public final class CDLearnCourse: NSManagedObject, WriteableModel {
    ...
    public static func save(
        ...
        let entity: CDLearnCourse = context.first(where: #keyPath(CDLearnCourse.id), equals: course.id) ?? context.insert()
        entity.id = course.id
