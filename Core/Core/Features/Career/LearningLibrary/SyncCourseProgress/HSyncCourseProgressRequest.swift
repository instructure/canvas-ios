...
public struct HSyncCourseProgressRequest: APIGraphQLRequestable {
    ...
    public static let operationName: String = "SyncCourseProgress"
    public var headers: [String: String?] = [
        HttpHeader.accept: "application/json"
    ]

    public init(courseId: String) {
        self.variables = .init(courseId: courseId)
    }
