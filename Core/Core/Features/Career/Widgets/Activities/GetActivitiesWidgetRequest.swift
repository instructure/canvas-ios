...
public struct GetActivitiesWidgetRequest: APIGraphQLRequestable {
    ...
    public static let operationName: String = "ActivitiesWidget"
    public static let query = """
    query \(operationName) {
        widgetData(
          widgetType: "learning_status_details",
          dataScope: "learner",
          timeSpan: {
            type: PAST_7_DAYS
          }
