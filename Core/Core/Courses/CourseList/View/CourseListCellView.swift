        ...
        HStack(alignment: .top, spacing: 0) {
            Button(action: toggleFavorite) {
                ...
                icon
                    ...
                    .padding(EdgeInsets(top: Typography.Spacings.textCellIconTopPadding, leading: Typography.Spacings.textCellIconLeadingPadding, bottom: 0, trailing: Typography.Spacings.textCellIconTrailingPadding))
            }
