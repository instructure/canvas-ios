...
extension UIImage {
    ...
    public enum InstIconName: String, CaseIterable {
        ...
        case add, addressBook, alerts, announcement, arrowOpenDown, arrowOpenLeft, arrowOpenRight,
            ...
            exitFullScreen, eye, folder, forward, fullScreen, gradebook, group, hamburger,
            highlighter, home, image, instructure, italic, link, lock, lti, marker, miniArrowDown,
            miniArrowUp, module, more, no, numberedList, outcomes, paint, paperclip, pause, pdf,
            play, prerequisite, publish, question, quiz, refresh, reply, replyAll, rubric, settings,
            star, strikethrough, text, textColor, trash, trouble, unlock, user, video, warning, x
    }
