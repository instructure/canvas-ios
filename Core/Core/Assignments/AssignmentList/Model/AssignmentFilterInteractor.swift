...
public protocol AssignmentFilterInteractor {
    ...
    func saveSortByOption(type: AssignmentArrangementOptions)
}

public final class AssignmentFilterInteractorLive {
...
extension AssignmentFilterInteractorLive: AssignmentFilterInteractor {
    ...
    public func saveSortByOption(type: AssignmentArrangementOptions) {
