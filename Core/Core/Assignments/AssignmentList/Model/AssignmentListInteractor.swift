...
public protocol AssignmentListInteractor {
    var courseID: String { get }
    func getAssignments(
        arrangeBy: AssignmentArrangementOptions,
        ignoreCache: Bool,
        shouldUpdateGradingPeriod: Bool
    ) -> AnyPublisher<AssignmentListData, Error>
    func updateGradingPeriod(id: String?)
}

public final class AssignmentListInteractorLive: AssignmentListInteractor {
    // MARK: - Dependencies
    ...
    public func getAssignments(
        ...
        .flatMap { [weak self] params -> AnyPublisher<AssignmentListData, Error> in
            ...
            let assignmentSections: [AssignmentListData.AssignmentSections]
            switch arrangeBy {
            case .dueDate:
            ...
            return assignmentSections.eraseToAnyPublisher()
        }
        .eraseToAnyPublisher()
    }
    ...
    private func arrangeAssignmentsByGroupNames(
    ...
    ) -> [AssignmentListData.AssignmentSections] {
        ...
        var assignmentSections: [AssignmentListData.AssignmentSections] = []
    ...
    private func arrangeAssignmentsByDueDate(
        ...
        var assignmentSections: [AssignmentListData.AssignmentSections] = []
        var overdueAssignments = AssignmentListData.AssignmentSections(
            id: "overdueAssignments",
            title: String(localized: "Overdue Assignments", bundle: .core),
            assignments: []
        )
        var upcomingAssignments = AssignmentListData.AssignmentSections(
            id: "upcomingAssignments",
            title: String(localized: "Upcoming Assignments", bundle: .core),
            assignments: []
        )
        var pastAssignments = AssignmentListData.AssignmentSections(
            id: "pastAssignments",
