...
open class CoreWebView: WKWebView {
    ...
    private func setup() {
        ...
        // This is to make sure offline preview files generated by
        // this instance get deleted at all times. See `loadContent(..)`
        // method for more information about how they get generated.
        NotificationCenter
            .default
            .publisher(for: UIApplication.willTerminateNotification)
            .sink { [weak self] _ in
                self?.cleanOfflinePreview()
            }
...
extension CoreWebView {
    ...
    public func loadContent(
        ...
        if let filePath, isOffline == true, FileManager.default.fileExists(atPath: filePath.path) {
            ...
            let previewHash = String(filePath.absoluteString.hashValue)
            let previewURL = URL
                .Directories
                .documents
                .appending(component: URL.Paths.offlinePreviewPrefix + previewHash)
