...
extension View {
    ...
    public func swipeAction<Label: View>(
        ...
        completionBehavior: AUI.SwipeCompletionBehavior = .stayOpen,
...
private struct SwipeActionModifier<Label: View>: ViewModifier {
    ...
    let completionBehavior: AUI.SwipeCompletionBehavior
    ...
    init(
        backgroundColor: Color,
        completionBehavior: AUI.SwipeCompletionBehavior,
