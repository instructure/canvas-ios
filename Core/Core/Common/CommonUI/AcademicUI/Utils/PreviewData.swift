...
extension String {
    public static let loremIpsumShort = AUI.PreviewData.loremIpsumShort
    public static let loremIpsumMedium = AUI.PreviewData.loremIpsumMedium
    public static let loremIpsumLong = AUI.PreviewData.loremIpsumLong

    public static func loremIpsumLong(_ multiplier: Int) -> String {
        AUI.PreviewData.loremIpsumLong(multiplier)
    }
}
