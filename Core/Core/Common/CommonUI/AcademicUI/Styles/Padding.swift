...
public extension AUI.Styles.Padding {
...
extension View {
    ...
    @inlinable
    public func paddingStyle(_ edges: Edge.Set = .all, _ padding: AUI.Styles.Padding) -> some View {
        self.padding(edges, padding.rawValue)
    }

    @inlinable
    public func paddingStyle(_ padding: AUI.Styles.Padding) -> some View {
        self.padding(padding.rawValue)
    }

    public func paddingStyle(set: AUI.Styles.PaddingSet) -> some View {
        self
            .padding(
                EdgeInsets(
