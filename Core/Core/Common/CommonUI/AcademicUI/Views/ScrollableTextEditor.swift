...
extension AUI {
    ...
    public struct ScrollableTextEditor: View {
        ...
        public var body: some View {
            AUI.UITextViewWrapper(text: $text, height: $textViewHeight) { textView in
...
struct ScrollableTextEditor_Previews: PreviewProvider {
    static var previews: some View {
        AUI.ScrollableTextEditor(text: .constant(""), placeholder: "Placeholder", font: .regular14)
            .previewLayout(.sizeThatFits)
            .border(Color.red)

        AUI.ScrollableTextEditor(text: .constant("Placeholder"), placeholder: "Placeholder", font: .regular14)
            .previewLayout(.sizeThatFits)
            .border(Color.red)

        AUI.ScrollableTextEditor(text: .constant("1"), font: .regular14)
            .previewLayout(.sizeThatFits)
            .border(Color.red)

        AUI.ScrollableTextEditor(text: .constant("1\n2"), font: .regular14)
            .previewLayout(.sizeThatFits)
            .border(Color.red)
