...
extension AUI.PageIndicator {
    struct Storybook: View {
        ...
        var body: some View {
            VStack(spacing: 20) {
                AUI.PageIndicator(currentIndex: currentPage, count: pageCount, maxDotsBeforeScroll: maxDotsBeforeScroll)
