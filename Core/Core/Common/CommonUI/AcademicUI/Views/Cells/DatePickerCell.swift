...
extension AUI {
    ...
    private enum Spacing {
        static let horizontal: CGFloat = AUI.Styles.Padding.standard.rawValue
        static let vertical: CGFloat = AUI.Styles.Padding.textVertical.rawValue
        static let pickerHorizontal: CGFloat = 4
        static let pickerVertical: CGFloat = AUI.Styles.Padding.textVertical.rawValue
...
#Preview {
    VStack {
        AUI.DatePickerCell(label: Text(verbatim: "Favorite Date"), date: .constant(nil), isClearable: true)
        AUI.DatePickerCell(label: Text(verbatim: "Favorite Date"), date: .constant(.now), isClearable: true)
        AUI.DatePickerCell(label: Text(verbatim: "Favorite Date"), date: .constant(.now), isClearable: false)
        AUI.DatePickerCell(label: Text(verbatim: "Favorite Date"), date: .constant(.now), errorMessage: "Someting is wrong here.")
        AUI.DatePickerCell(label: Text(verbatim: "Just Date"), date: .constant(.now), mode: .dateOnly)
        AUI.DatePickerCell(
