...
extension AUI {
    ...
    public struct SelectionMenuCell<Label, Value, ID>: View where Label: View, Value: Equatable, ID: Hashable {
        ...
        public var body: some View {
            VStack(spacing: 0) {
                HStack(spacing: AUI.Styles.Padding.standard.rawValue) {
...
extension AUI.SelectionMenuCell where Value: Identifiable, ID == Value.ID {
    init(label: Label,
         options: [Value],
         text: KeyPath<Value, String>,
         selection: Binding<Value?>) {
...
extension AUI.SelectionMenuCell {
