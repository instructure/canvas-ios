...
extension AUI.NavigationBarButton {
...
private func previewsFactory(isContextBackground: Bool) -> some View {
    VStack {
        AUI.NavigationBarButton.cancel(isBackgroundContextColor: isContextBackground) { }

        AUI.NavigationBarButton.done(isBackgroundContextColor: isContextBackground) { }
            .disabled(true)

        AUI.NavigationBarButton.add(isBackgroundContextColor: isContextBackground, isEnabled: false) { }

        AUI.NavigationBarButton(isBackgroundContextColor: isContextBackground, isEnabled: true, title: "Enabled button") { }

        AUI.NavigationBarButton(isBackgroundContextColor: isContextBackground, isEnabled: false, title: "Disabled button") { }
            .disabled(false)

        AUI.NavigationBarButton(isBackgroundContextColor: isContextBackground, isEnabled: true, image: .settingsLine, accessibilityLabel: "Settings") { }

        AUI.NavigationBarButton(isBackgroundContextColor: isContextBackground, isEnabled: false, action: {}) {
