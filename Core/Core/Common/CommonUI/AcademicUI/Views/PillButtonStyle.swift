...
extension ButtonStyle where Self == AUI.PillButtonStyle {

    public static var pillTintFilled: Self {
        AUI.PillButtonStyle(.tintFilled)
    }

    public static var pillTintOutlined: Self {
        AUI.PillButtonStyle(.tintOutlined)
    }

    public static var pillDefaultOutlined: Self {
        AUI.PillButtonStyle(.defaultOutlined)
    }

    public static func pillCustomOutlined(textColor: Color, borderColor: Color) -> Self {
        AUI.PillButtonStyle(.customOutlined(textColor: textColor, borderColor: borderColor))
    }
}
...
extension AUI {
    ...
    public struct PillButtonStyle: ButtonStyle {
        ...
        private let buttonStyleConfig: AUI.PillButtonStyle.Config

        public init(_ buttonStyleConfig: AUI.PillButtonStyle.Config) {
