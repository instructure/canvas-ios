            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 16) {
                    ...
                    HStack(alignment: .top) {
                        Button {} label: {
                            AUI.PillContent(title: "Height 30", trailingIcon: .infoLine, size: .height30)
                        }
                        .buttonStyle(.pillDefaultOutlined)

                        Button {} label: {
                            AUI.PillContent(title: "Height 24", trailingIcon: .infoLine, size: .height24)
                        }
                        .buttonStyle(.pillDefaultOutlined)

                        Button {} label: {
                            AUI.PillContent(title: "Height 20", trailingIcon: .infoLine, size: .height20)
                        }
                        .buttonStyle(.pillDefaultOutlined)
                    }
