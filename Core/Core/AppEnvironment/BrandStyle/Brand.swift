...
public struct Brand: Equatable {
    ...
    public init(
        ...
        self.headerImageBackgroundDark = headerImageBackground ?? .backgroundDarkest.lightVariant
        self.linkColorDark = linkColor != nil ? linkColor!.ensureContrast(against: .backgroundLightest) : .textInfo
        self.navBackgroundDark = navBackground ?? .backgroundDarkest.lightVariant
