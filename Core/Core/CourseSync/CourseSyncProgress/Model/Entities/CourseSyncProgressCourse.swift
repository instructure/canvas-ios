...
public final class CourseSyncProgressCourse: NSManagedObject {
    ...
    public static func save(_ apiEntity: APICourse,
                            ...
                            in context: NSManagedObjectContext) -> CourseSyncProgressCourse {
        let dbEntity: CourseSyncProgressCourse = context.first(
            where: #keyPath(CourseSyncProgressCourse.courseId),
