...
struct AudioPicker: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<AudioPicker>) -> AudioRecorderViewController {
    ...
    func updateUIViewController(_ uiViewController: AudioRecorderViewController, context: UIViewControllerRepresentableContext<AudioPicker>) {
