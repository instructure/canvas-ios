...
for (const name of Object.keys(colors)) {
  ...
  // iOS <13 require a separate color asset for high contrast & don't have dark mode
  write(`${root}/${name}HighContrast.colorset/Contents.json`, {
    info: {
      version: 1,
      author: 'xcode',
    },
...
fs.writeFileSync('./Core/Core/Extensions/UIColorInstColorsExtensions.swift', `//
// This file is part of Canvas.
// Copyright (C) 2019-present  Instructure, Inc.
//
// This program is free software: you can redistribute it and/or modify
