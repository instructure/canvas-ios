...
/**
 ...
 @note Subclassing `PSPDFFileAnnotationProvider` will lead to slower `PSPDFProcessor` performance and is not recommended. This will be blocked in future versions.
 */
...
/**
 ...
 Will be called from `annotationsForPageAtIndex:` in a thread safe manner and later cached.
 */
- (nullable NSArray<PSPDFAnnotation *> *)parseAnnotationsForPageAtIndex:(NSUInteger)pageIndex;
