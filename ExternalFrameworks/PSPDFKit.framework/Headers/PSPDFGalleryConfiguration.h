 ...
 */
PSPDF_CLASS_AVAILABLE_SUBCLASSING_RESTRICTED @interface PSPDFGalleryConfigurationBuilder : PSPDFBaseConfigurationBuilder

@end

/// A `PSPDFGalleryConfiguration` defines the behavior of a `PSPDFGalleryViewController`.
PSPDF_CLASS_AVAILABLE_SUBCLASSING_RESTRICTED @interface PSPDFGalleryConfiguration : PSPDFBaseConfiguration<PSPDFGalleryConfigurationBuilder *>
