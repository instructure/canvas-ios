...
/**
 The note annotation controller can be used for any type of annotation (showing `contents`)
 For PSPDFNoteAnnotation object types, additional options are displayed.
 */
PSPDF_CLASS_AVAILABLE @interface PSPDFNoteAnnotationViewController : PSPDFBaseViewController<UITextViewDelegate, PSPDFStyleable>
...
/**
 ...
 @note The text view delegate is wired to the controller and methods can be implemented as needed.
 Do not call super when implementing `UITextViewDelegate` methods.
