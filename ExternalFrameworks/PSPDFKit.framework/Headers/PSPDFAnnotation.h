...
PSPDF_EXPORT NSString *const PSPDFAnnotationStringLink;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringHighlight;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringUnderline;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringStrikeOut;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringSquiggly;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringNote;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringFreeText;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringInk;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringSquare;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringCircle;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringLine;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringPolygon;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringPolyLine;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringSignature;  /// Signature is a `PSPDFAnnotationStringInk` annotation.
PSPDF_EXPORT NSString *const PSPDFAnnotationStringStamp;
...
PSPDF_EXPORT NSString *const PSPDFAnnotationStringSound;
...
PSPDF_EXPORT NSString *const PSPDFAnnotationStringImage;      // Image is a `PSPDFAnnotationStringStamp` annotation.

/// Non-writable annotation types.
PSPDF_EXPORT NSString *const PSPDFAnnotationStringWidget;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringFile;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringRichMedia;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringScreen;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringCaret;

/// Placeholders. Not yet supported.
PSPDF_EXPORT NSString *const PSPDFAnnotationStringPopup;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringWatermark;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringTrapNet;
PSPDF_EXPORT NSString *const PSPDFAnnotationString3D;
PSPDF_EXPORT NSString *const PSPDFAnnotationStringRedact;
...
PSPDF_EXPORT NSString * _Nullable PSPDFStringFromAnnotationType(PSPDFAnnotationType annotationType);

/// Converts the annotation type string representation to an annotation type.
PSPDF_EXPORT PSPDFAnnotationType PSPDFAnnotationTypeFromString(NSString * _Nullable string);
...
typedef NS_OPTIONS(NSUInteger, PSPDFAnnotationFlags) {
    ...
    /// [IGNORED] If set, print the annotation when the page is printed. Default value.
    ...
    /// [IGNORED] If set, don't allow the annotation to interact with the user. Ignored for Widget.
    PSPDFAnnotationFlagReadOnly       = 1 << 6,
    /// [IGNORED] If set, don't allow the annotation to be deleted or properties modified (except contents)
...
+ (PSPDFAnnotation *)annotationFromJSONDictionary:(NSDictionary<NSString *, id> *)JSONDictionary documentProvider:(nullable PSPDFDocumentProvider *)documentProvider error:(NSError **)error;
...
@property (nonatomic) NSUInteger absolutePage;
...
- (nullable UIImage *)extractImageFromAppearanceStreamWithTransform:(out CGAffineTransform * _Nullable)transform error:(NSError *__autoreleasing*)error;
...
/// `options can be `PSPDFAnnotationDrawAppearanceStreamKey`, `PSPDFAnnotationDrawFlattenedKey`, `PSPDFAnnotationIgnoreNoteIndicatorIconKey` and other render-releated keys.
...
/// Attributed string, used for free text and various form elements.
