 ...
 */
- (void)documentPickerController:(PSPDFDocumentPickerController *)controller didSelectDocument:(PSPDFDocument *)document pageIndex:(NSUInteger)pageIndex searchString:(NSString *)searchString;
