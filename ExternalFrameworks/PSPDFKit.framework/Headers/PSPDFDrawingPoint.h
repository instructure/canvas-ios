...
NS_INLINE PSPDFDrawingPoint PSPDFDrawingPointMake(CGPoint location, CGFloat intensity) { return (PSPDFDrawingPoint){location, intensity}; }

/// Creates a new `PSPDFDrawingPoint` from a `CGPoint`, using `PSPDFDefaultIntensity`.
NS_INLINE PSPDFDrawingPoint PSPDFDrawingPointFromCGPoint(CGPoint location) { return (PSPDFDrawingPoint){location, PSPDFDefaultIntensity}; }
