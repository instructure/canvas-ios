...
class CoursesTests: E2ETestCase {
    ...
    func testCourses() {
        ...
        XCTAssertVisible(courseTitleLabel1)
        XCTAssertVisible(courseGradeLabel1)
        ...
        XCTAssertVisible(courseTitleLabel2)
        XCTAssertVisible(courseGradeLabel2)
        ...
        XCTAssertVisible(assignmentCell2)
        XCTAssertVisible(letterGradeLabelOfAssignment1)
