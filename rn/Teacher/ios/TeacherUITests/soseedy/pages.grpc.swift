...
internal protocol Soseedy_SeedyPagesCreateCoursePageCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyPagesService: ServiceClient {
  /// Synchronous. Unary.
...
internal final class Soseedy_SeedyPagesServiceClient: ServiceClientBase, Soseedy_SeedyPagesService {
  /// Synchronous. Unary.
  internal func createCoursePage(_ request: Soseedy_CreateCoursePageRequest) throws -> Soseedy_Page {
    return try Soseedy_SeedyPagesCreateCoursePageCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createCoursePage(_ request: Soseedy_CreateCoursePageRequest, completion: @escaping (Soseedy_Page?, CallResult) -> Void) throws -> Soseedy_SeedyPagesCreateCoursePageCall {
    return try Soseedy_SeedyPagesCreateCoursePageCallBase(channel)
...
internal protocol Soseedy_SeedyPagesCreateCoursePageSession: ServerSessionUnary {}
...
internal final class Soseedy_SeedyPagesServer: ServiceServer {
  private let provider: Soseedy_SeedyPagesProvider

  internal init(address: String, provider: Soseedy_SeedyPagesProvider) {
    self.provider = provider
    super.init(address: address)
  }

  internal init?(address: String, certificateURL: URL, keyURL: URL, provider: Soseedy_SeedyPagesProvider) {
    self.provider = provider
    super.init(address: address, certificateURL: certificateURL, keyURL: keyURL)
  }

  internal init?(address: String, certificateString: String, keyString: String, provider: Soseedy_SeedyPagesProvider) {
    self.provider = provider
