...
internal enum Soseedy_SeedyPagesClientError : Error {
  case endOfStream
...
internal class Soseedy_SeedyPagesCreateCoursePageCall {
  private var call : Call

  /// Create a call.
  fileprivate init(_ channel: Channel) {
    self.call = channel.makeCall("/soseedy.SeedyPages/CreateCoursePage")
  }
  ...
  fileprivate func run(request: Soseedy_CreateCoursePageRequest,
    ...
    if let returnResponse = returnResponse {
      ...
      throw Soseedy_SeedyPagesClientError.error(c: returnCallResult)
    }
  }
  ...
  fileprivate func start(request: Soseedy_CreateCoursePageRequest,
    ...
    throws -> Soseedy_SeedyPagesCreateCoursePageCall {
...
internal class Soseedy_SeedyPagesService {
  ...
  internal func createcoursepage(_ request: Soseedy_CreateCoursePageRequest)
    throws
    -> Soseedy_Page {
      return try Soseedy_SeedyPagesCreateCoursePageCall(channel).run(request:request, metadata:metadata)
  }
  /// Asynchronous. Unary.
  internal func createcoursepage(_ request: Soseedy_CreateCoursePageRequest,
                  completion: @escaping (Soseedy_Page?, CallResult)->())
    throws
    -> Soseedy_SeedyPagesCreateCoursePageCall {
      return try Soseedy_SeedyPagesCreateCoursePageCall(channel).start(request:request,
                                                 metadata:metadata,
...
internal enum Soseedy_SeedyPagesServerError : Error {
  case endOfStream
}

/// To build a server, implement a class that conforms to this protocol.
internal protocol Soseedy_SeedyPagesProvider {
...
internal class Soseedy_SeedyPagesSession {
...
// CreateCoursePage (Unary)
internal class Soseedy_SeedyPagesCreateCoursePageSession : Soseedy_SeedyPagesSession {
  private var provider : Soseedy_SeedyPagesProvider

  /// Create a session.
  fileprivate init(handler:gRPC.Handler, provider: Soseedy_SeedyPagesProvider) {
  ...
  fileprivate func run(queue:DispatchQueue) throws {
    try handler.receiveMessage(initialMetadata:initialMetadata) {(requestData) in
      if let requestData = requestData {
        let requestMessage = try Soseedy_CreateCoursePageRequest(serializedData:requestData)
        let replyMessage = try self.provider.createcoursepage(request:requestMessage, session: self)
...
internal class Soseedy_SeedyPagesServer {
  ...
  internal init(address:String,
              provider:Soseedy_SeedyPagesProvider) {
    gRPC.initialize()
    ...
    server.run {(handler) in
      ...
      do {
        ...
        case "/soseedy.SeedyPages/CreateCoursePage":
          try Soseedy_SeedyPagesCreateCoursePageSession(handler:handler, provider:provider).run(queue:queue)
        default:
