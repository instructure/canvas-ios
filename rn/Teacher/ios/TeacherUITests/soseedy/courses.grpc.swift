...
internal protocol Soseedy_SeedyCoursesCreateCourseCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyCoursesAddFavoriteCourseCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyCoursesService: ServiceClient {
  /// Synchronous. Unary.
...
internal final class Soseedy_SeedyCoursesServiceClient: ServiceClientBase, Soseedy_SeedyCoursesService {
  /// Synchronous. Unary.
  internal func createCourse(_ request: Soseedy_CreateCourseRequest) throws -> Soseedy_Course {
    return try Soseedy_SeedyCoursesCreateCourseCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createCourse(_ request: Soseedy_CreateCourseRequest, completion: @escaping (Soseedy_Course?, CallResult) -> Void) throws -> Soseedy_SeedyCoursesCreateCourseCall {
    return try Soseedy_SeedyCoursesCreateCourseCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func addFavoriteCourse(_ request: Soseedy_AddFavoriteCourseRequest) throws -> Soseedy_Favorite {
    return try Soseedy_SeedyCoursesAddFavoriteCourseCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func addFavoriteCourse(_ request: Soseedy_AddFavoriteCourseRequest, completion: @escaping (Soseedy_Favorite?, CallResult) -> Void) throws -> Soseedy_SeedyCoursesAddFavoriteCourseCall {
    return try Soseedy_SeedyCoursesAddFavoriteCourseCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }
...
internal protocol Soseedy_SeedyCoursesCreateCourseSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyCoursesAddFavoriteCourseSession: ServerSessionUnary {}
...
internal final class Soseedy_SeedyCoursesServer: ServiceServer {
  private let provider: Soseedy_SeedyCoursesProvider

  internal init(address: String, provider: Soseedy_SeedyCoursesProvider) {
    self.provider = provider
    super.init(address: address)
  }

  internal init?(address: String, certificateURL: URL, keyURL: URL, provider: Soseedy_SeedyCoursesProvider) {
    self.provider = provider
    super.init(address: address, certificateURL: certificateURL, keyURL: keyURL)
  }

  internal init?(address: String, certificateString: String, keyString: String, provider: Soseedy_SeedyCoursesProvider) {
    self.provider = provider
