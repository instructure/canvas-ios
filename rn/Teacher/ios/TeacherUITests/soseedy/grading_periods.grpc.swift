...
internal protocol Soseedy_SeedyGradingPeriodsCreateGradingPeriodSetCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyGradingPeriodsCreateGradingPeriodCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyGradingPeriodsService: ServiceClient {
  /// Synchronous. Unary.
...
internal final class Soseedy_SeedyGradingPeriodsServiceClient: ServiceClientBase, Soseedy_SeedyGradingPeriodsService {
  /// Synchronous. Unary.
  internal func createGradingPeriodSet(_ request: Soseedy_CreateGradingPeriodSetRequest) throws -> Soseedy_GradingPeriodSet {
    return try Soseedy_SeedyGradingPeriodsCreateGradingPeriodSetCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createGradingPeriodSet(_ request: Soseedy_CreateGradingPeriodSetRequest, completion: @escaping (Soseedy_GradingPeriodSet?, CallResult) -> Void) throws -> Soseedy_SeedyGradingPeriodsCreateGradingPeriodSetCall {
    return try Soseedy_SeedyGradingPeriodsCreateGradingPeriodSetCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func createGradingPeriod(_ request: Soseedy_CreateGradingPeriodRequest) throws -> Soseedy_GradingPeriod {
    return try Soseedy_SeedyGradingPeriodsCreateGradingPeriodCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createGradingPeriod(_ request: Soseedy_CreateGradingPeriodRequest, completion: @escaping (Soseedy_GradingPeriod?, CallResult) -> Void) throws -> Soseedy_SeedyGradingPeriodsCreateGradingPeriodCall {
    return try Soseedy_SeedyGradingPeriodsCreateGradingPeriodCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }
...
internal protocol Soseedy_SeedyGradingPeriodsCreateGradingPeriodSetSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyGradingPeriodsCreateGradingPeriodSession: ServerSessionUnary {}
...
internal final class Soseedy_SeedyGradingPeriodsServer: ServiceServer {
  private let provider: Soseedy_SeedyGradingPeriodsProvider

  internal init(address: String, provider: Soseedy_SeedyGradingPeriodsProvider) {
    self.provider = provider
    super.init(address: address)
  }

  internal init?(address: String, certificateURL: URL, keyURL: URL, provider: Soseedy_SeedyGradingPeriodsProvider) {
    self.provider = provider
    super.init(address: address, certificateURL: certificateURL, keyURL: keyURL)
  }

  internal init?(address: String, certificateString: String, keyString: String, provider: Soseedy_SeedyGradingPeriodsProvider) {
    self.provider = provider
