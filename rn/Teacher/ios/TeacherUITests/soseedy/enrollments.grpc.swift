...
internal protocol Soseedy_SeedyEnrollmentsCreateEnrollmentTermCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyEnrollmentsEnrollUserInCourseCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyEnrollmentsEnrollUserInSectionCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyEnrollmentsService: ServiceClient {
  /// Synchronous. Unary.
...
internal final class Soseedy_SeedyEnrollmentsServiceClient: ServiceClientBase, Soseedy_SeedyEnrollmentsService {
  /// Synchronous. Unary.
  internal func createEnrollmentTerm(_ request: Soseedy_CreateEnrollmentTermRequest) throws -> Soseedy_EnrollmentTerm {
    return try Soseedy_SeedyEnrollmentsCreateEnrollmentTermCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createEnrollmentTerm(_ request: Soseedy_CreateEnrollmentTermRequest, completion: @escaping (Soseedy_EnrollmentTerm?, CallResult) -> Void) throws -> Soseedy_SeedyEnrollmentsCreateEnrollmentTermCall {
    return try Soseedy_SeedyEnrollmentsCreateEnrollmentTermCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func enrollUserInCourse(_ request: Soseedy_EnrollUserRequest) throws -> Soseedy_Enrollment {
    return try Soseedy_SeedyEnrollmentsEnrollUserInCourseCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func enrollUserInCourse(_ request: Soseedy_EnrollUserRequest, completion: @escaping (Soseedy_Enrollment?, CallResult) -> Void) throws -> Soseedy_SeedyEnrollmentsEnrollUserInCourseCall {
    return try Soseedy_SeedyEnrollmentsEnrollUserInCourseCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func enrollUserInSection(_ request: Soseedy_EnrollUserInSectionRequest) throws -> Soseedy_Enrollment {
    return try Soseedy_SeedyEnrollmentsEnrollUserInSectionCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func enrollUserInSection(_ request: Soseedy_EnrollUserInSectionRequest, completion: @escaping (Soseedy_Enrollment?, CallResult) -> Void) throws -> Soseedy_SeedyEnrollmentsEnrollUserInSectionCall {
    return try Soseedy_SeedyEnrollmentsEnrollUserInSectionCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }
...
internal protocol Soseedy_SeedyEnrollmentsCreateEnrollmentTermSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyEnrollmentsEnrollUserInCourseSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyEnrollmentsEnrollUserInSectionSession: ServerSessionUnary {}
...
internal final class Soseedy_SeedyEnrollmentsServer: ServiceServer {
  private let provider: Soseedy_SeedyEnrollmentsProvider

  internal init(address: String, provider: Soseedy_SeedyEnrollmentsProvider) {
    self.provider = provider
    super.init(address: address)
  }

  internal init?(address: String, certificateURL: URL, keyURL: URL, provider: Soseedy_SeedyEnrollmentsProvider) {
    self.provider = provider
    super.init(address: address, certificateURL: certificateURL, keyURL: keyURL)
  }

  internal init?(address: String, certificateString: String, keyString: String, provider: Soseedy_SeedyEnrollmentsProvider) {
    self.provider = provider
