...
internal protocol Soseedy_SeedyGeneralGetHealthCheckCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyGeneralSeedDataCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyGeneralService: ServiceClient {
  /// Synchronous. Unary.
...
internal final class Soseedy_SeedyGeneralServiceClient: ServiceClientBase, Soseedy_SeedyGeneralService {
  /// Synchronous. Unary.
  internal func getHealthCheck(_ request: Soseedy_HealthCheckRequest) throws -> Soseedy_HealthCheck {
    return try Soseedy_SeedyGeneralGetHealthCheckCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func getHealthCheck(_ request: Soseedy_HealthCheckRequest, completion: @escaping (Soseedy_HealthCheck?, CallResult) -> Void) throws -> Soseedy_SeedyGeneralGetHealthCheckCall {
    return try Soseedy_SeedyGeneralGetHealthCheckCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func seedData(_ request: Soseedy_SeedDataRequest) throws -> Soseedy_SeededData {
    return try Soseedy_SeedyGeneralSeedDataCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func seedData(_ request: Soseedy_SeedDataRequest, completion: @escaping (Soseedy_SeededData?, CallResult) -> Void) throws -> Soseedy_SeedyGeneralSeedDataCall {
    return try Soseedy_SeedyGeneralSeedDataCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }
...
internal protocol Soseedy_SeedyGeneralGetHealthCheckSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyGeneralSeedDataSession: ServerSessionUnary {}
...
internal final class Soseedy_SeedyGeneralServer: ServiceServer {
  private let provider: Soseedy_SeedyGeneralProvider

  internal init(address: String, provider: Soseedy_SeedyGeneralProvider) {
    self.provider = provider
    super.init(address: address)
  }

  internal init?(address: String, certificateURL: URL, keyURL: URL, provider: Soseedy_SeedyGeneralProvider) {
    self.provider = provider
    super.init(address: address, certificateURL: certificateURL, keyURL: keyURL)
  }

  internal init?(address: String, certificateString: String, keyString: String, provider: Soseedy_SeedyGeneralProvider) {
    self.provider = provider
