...
internal protocol Soseedy_SeedyDiscussionsCreateAnnouncementCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyDiscussionsCreateDiscussionCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyDiscussionsService: ServiceClient {
  /// Synchronous. Unary.
...
internal final class Soseedy_SeedyDiscussionsServiceClient: ServiceClientBase, Soseedy_SeedyDiscussionsService {
  /// Synchronous. Unary.
  internal func createAnnouncement(_ request: Soseedy_CreateAnnouncementRequest) throws -> Soseedy_Discussion {
    return try Soseedy_SeedyDiscussionsCreateAnnouncementCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createAnnouncement(_ request: Soseedy_CreateAnnouncementRequest, completion: @escaping (Soseedy_Discussion?, CallResult) -> Void) throws -> Soseedy_SeedyDiscussionsCreateAnnouncementCall {
    return try Soseedy_SeedyDiscussionsCreateAnnouncementCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func createDiscussion(_ request: Soseedy_CreateDiscussionRequest) throws -> Soseedy_Discussion {
    return try Soseedy_SeedyDiscussionsCreateDiscussionCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createDiscussion(_ request: Soseedy_CreateDiscussionRequest, completion: @escaping (Soseedy_Discussion?, CallResult) -> Void) throws -> Soseedy_SeedyDiscussionsCreateDiscussionCall {
    return try Soseedy_SeedyDiscussionsCreateDiscussionCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }
...
internal protocol Soseedy_SeedyDiscussionsCreateAnnouncementSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyDiscussionsCreateDiscussionSession: ServerSessionUnary {}
...
internal final class Soseedy_SeedyDiscussionsServer: ServiceServer {
  private let provider: Soseedy_SeedyDiscussionsProvider

  internal init(address: String, provider: Soseedy_SeedyDiscussionsProvider) {
    self.provider = provider
    super.init(address: address)
  }

  internal init?(address: String, certificateURL: URL, keyURL: URL, provider: Soseedy_SeedyDiscussionsProvider) {
    self.provider = provider
    super.init(address: address, certificateURL: certificateURL, keyURL: keyURL)
  }

  internal init?(address: String, certificateString: String, keyString: String, provider: Soseedy_SeedyDiscussionsProvider) {
    self.provider = provider
