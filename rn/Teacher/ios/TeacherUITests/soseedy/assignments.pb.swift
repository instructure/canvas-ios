...
struct Soseedy_CourseAssignmentSubmission: SwiftProtobuf.Message {
  ...
  var submissionComments: [Soseedy_AssignmentSubmissionComment] = []
...
struct Soseedy_AssignmentSubmissionComment: SwiftProtobuf.Message {
  static let protoMessageName: String = _protobuf_package + ".AssignmentSubmissionComment"
...
extension Soseedy_AssignmentSubmissionComment: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  func _protobuf_generated_isEqualTo(other: Soseedy_AssignmentSubmissionComment) -> Bool {
