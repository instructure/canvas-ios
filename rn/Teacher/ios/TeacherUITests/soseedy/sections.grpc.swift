...
internal protocol Soseedy_SeedySectionsCreateSectionCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedySectionsService: ServiceClient {
  /// Synchronous. Unary.
...
internal final class Soseedy_SeedySectionsServiceClient: ServiceClientBase, Soseedy_SeedySectionsService {
  /// Synchronous. Unary.
  internal func createSection(_ request: Soseedy_CreateSectionRequest) throws -> Soseedy_Section {
    return try Soseedy_SeedySectionsCreateSectionCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createSection(_ request: Soseedy_CreateSectionRequest, completion: @escaping (Soseedy_Section?, CallResult) -> Void) throws -> Soseedy_SeedySectionsCreateSectionCall {
    return try Soseedy_SeedySectionsCreateSectionCallBase(channel)
...
internal protocol Soseedy_SeedySectionsCreateSectionSession: ServerSessionUnary {}
...
internal final class Soseedy_SeedySectionsServer: ServiceServer {
  private let provider: Soseedy_SeedySectionsProvider

  internal init(address: String, provider: Soseedy_SeedySectionsProvider) {
    self.provider = provider
    super.init(address: address)
  }

  internal init?(address: String, certificateURL: URL, keyURL: URL, provider: Soseedy_SeedySectionsProvider) {
    self.provider = provider
    super.init(address: address, certificateURL: certificateURL, keyURL: keyURL)
  }

  internal init?(address: String, certificateString: String, keyString: String, provider: Soseedy_SeedySectionsProvider) {
    self.provider = provider
