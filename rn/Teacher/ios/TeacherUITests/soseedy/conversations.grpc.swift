...
internal protocol Soseedy_SeedyConversationsCreateConversationCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyConversationsService: ServiceClient {
  /// Synchronous. Unary.
...
internal final class Soseedy_SeedyConversationsServiceClient: ServiceClientBase, Soseedy_SeedyConversationsService {
  /// Synchronous. Unary.
  internal func createConversation(_ request: Soseedy_CreateConversationRequest) throws -> Soseedy_Conversation {
    return try Soseedy_SeedyConversationsCreateConversationCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createConversation(_ request: Soseedy_CreateConversationRequest, completion: @escaping (Soseedy_Conversation?, CallResult) -> Void) throws -> Soseedy_SeedyConversationsCreateConversationCall {
    return try Soseedy_SeedyConversationsCreateConversationCallBase(channel)
...
internal protocol Soseedy_SeedyConversationsCreateConversationSession: ServerSessionUnary {}
...
internal final class Soseedy_SeedyConversationsServer: ServiceServer {
  private let provider: Soseedy_SeedyConversationsProvider

  internal init(address: String, provider: Soseedy_SeedyConversationsProvider) {
    self.provider = provider
    super.init(address: address)
  }

  internal init?(address: String, certificateURL: URL, keyURL: URL, provider: Soseedy_SeedyConversationsProvider) {
    self.provider = provider
    super.init(address: address, certificateURL: certificateURL, keyURL: keyURL)
  }

  internal init?(address: String, certificateString: String, keyString: String, provider: Soseedy_SeedyConversationsProvider) {
    self.provider = provider
