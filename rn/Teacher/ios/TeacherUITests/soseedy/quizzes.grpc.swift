...
internal protocol Soseedy_SeedyQuizzesCreateQuizCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyQuizzesCreateQuizSubmissionCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyQuizzesCompleteQuizSubmissionCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyQuizzesCreateQuizQuestionCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyQuizzesPublishQuizCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyQuizzesSeedQuizzesCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyQuizzesSeedQuizSubmissionCall: ClientCallUnary {}
...
internal protocol Soseedy_SeedyQuizzesService: ServiceClient {
  /// Synchronous. Unary.
...
internal final class Soseedy_SeedyQuizzesServiceClient: ServiceClientBase, Soseedy_SeedyQuizzesService {
  /// Synchronous. Unary.
  internal func createQuiz(_ request: Soseedy_CreateQuizRequest) throws -> Soseedy_Quiz {
    return try Soseedy_SeedyQuizzesCreateQuizCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createQuiz(_ request: Soseedy_CreateQuizRequest, completion: @escaping (Soseedy_Quiz?, CallResult) -> Void) throws -> Soseedy_SeedyQuizzesCreateQuizCall {
    return try Soseedy_SeedyQuizzesCreateQuizCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func createQuizSubmission(_ request: Soseedy_CreateQuizSubmissionRequest) throws -> Soseedy_QuizSubmission {
    return try Soseedy_SeedyQuizzesCreateQuizSubmissionCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createQuizSubmission(_ request: Soseedy_CreateQuizSubmissionRequest, completion: @escaping (Soseedy_QuizSubmission?, CallResult) -> Void) throws -> Soseedy_SeedyQuizzesCreateQuizSubmissionCall {
    return try Soseedy_SeedyQuizzesCreateQuizSubmissionCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func completeQuizSubmission(_ request: Soseedy_CompleteQuizSubmissionRequest) throws -> Soseedy_QuizSubmission {
    return try Soseedy_SeedyQuizzesCompleteQuizSubmissionCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func completeQuizSubmission(_ request: Soseedy_CompleteQuizSubmissionRequest, completion: @escaping (Soseedy_QuizSubmission?, CallResult) -> Void) throws -> Soseedy_SeedyQuizzesCompleteQuizSubmissionCall {
    return try Soseedy_SeedyQuizzesCompleteQuizSubmissionCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func createQuizQuestion(_ request: Soseedy_CreateQuizQuestionRequest) throws -> Soseedy_CreateQuizQuestionResponse {
    return try Soseedy_SeedyQuizzesCreateQuizQuestionCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func createQuizQuestion(_ request: Soseedy_CreateQuizQuestionRequest, completion: @escaping (Soseedy_CreateQuizQuestionResponse?, CallResult) -> Void) throws -> Soseedy_SeedyQuizzesCreateQuizQuestionCall {
    return try Soseedy_SeedyQuizzesCreateQuizQuestionCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func publishQuiz(_ request: Soseedy_PublishQuizRequest) throws -> Soseedy_Quiz {
    return try Soseedy_SeedyQuizzesPublishQuizCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func publishQuiz(_ request: Soseedy_PublishQuizRequest, completion: @escaping (Soseedy_Quiz?, CallResult) -> Void) throws -> Soseedy_SeedyQuizzesPublishQuizCall {
    return try Soseedy_SeedyQuizzesPublishQuizCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func seedQuizzes(_ request: Soseedy_SeedQuizzesRequest) throws -> Soseedy_Quizzes {
    return try Soseedy_SeedyQuizzesSeedQuizzesCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func seedQuizzes(_ request: Soseedy_SeedQuizzesRequest, completion: @escaping (Soseedy_Quizzes?, CallResult) -> Void) throws -> Soseedy_SeedyQuizzesSeedQuizzesCall {
    return try Soseedy_SeedyQuizzesSeedQuizzesCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func seedQuizSubmission(_ request: Soseedy_SeedQuizSubmissionRequest) throws -> Soseedy_QuizSubmission {
    return try Soseedy_SeedyQuizzesSeedQuizSubmissionCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func seedQuizSubmission(_ request: Soseedy_SeedQuizSubmissionRequest, completion: @escaping (Soseedy_QuizSubmission?, CallResult) -> Void) throws -> Soseedy_SeedyQuizzesSeedQuizSubmissionCall {
    return try Soseedy_SeedyQuizzesSeedQuizSubmissionCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }
...
internal protocol Soseedy_SeedyQuizzesCreateQuizSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyQuizzesCreateQuizSubmissionSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyQuizzesCompleteQuizSubmissionSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyQuizzesCreateQuizQuestionSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyQuizzesPublishQuizSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyQuizzesSeedQuizzesSession: ServerSessionUnary {}
...
internal protocol Soseedy_SeedyQuizzesSeedQuizSubmissionSession: ServerSessionUnary {}
...
internal final class Soseedy_SeedyQuizzesServer: ServiceServer {
  private let provider: Soseedy_SeedyQuizzesProvider

  internal init(address: String, provider: Soseedy_SeedyQuizzesProvider) {
    self.provider = provider
    super.init(address: address)
  }

  internal init?(address: String, certificateURL: URL, keyURL: URL, provider: Soseedy_SeedyQuizzesProvider) {
    self.provider = provider
    super.init(address: address, certificateURL: certificateURL, keyURL: keyURL)
  }

  internal init?(address: String, certificateString: String, keyString: String, provider: Soseedy_SeedyQuizzesProvider) {
    self.provider = provider
