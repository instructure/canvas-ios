...
export type InstIconName =
  ...
  'courses' | 'dashboard' | 'discussion' | 'document' | 'email' | 'empty' | 'exitFullScreen' |
  'eye' | 'folder' | 'forward' | 'fullScreen' | 'gradebook' | 'group' | 'hamburger' | 'highlighter' |
  'home' | 'image' | 'instructure' | 'italic' | 'link' | 'lock' | 'lti' | 'marker' |
  'miniArrowDown' | 'miniArrowUp' | 'module' | 'more' | 'no' | 'numberedList' | 'outcomes' |
  'paint' | 'paperclip' | 'pause' | 'pdf' | 'play' | 'prerequisite' | 'publish' | 'question' |
