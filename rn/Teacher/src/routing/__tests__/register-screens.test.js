...
describe('app routes', () => {
  ...
  it('includes /courses/:courseID/assignments/:assignmentID/rubrics/:rubricID/description', () => {
    expect(route('/courses/686/assignments/1/rubrics/2/description')).toEqual({
      screen: screenID('/courses/:courseID/assignments/:assignmentID/rubrics/:rubricID/description'),
      passProps: { courseID: '686', assignmentID: '1', rubricID: '2' },
    })
  })

  it('includes /courses/:courseID/quizzes', () => {
    expect(route('/courses/686/quizzes')).toEqual({
      screen: screenID('/courses/:courseID/quizzes'),
      passProps: { courseID: '686' },
    })
  })

  it('includes quiz details', () => {
    expect(route('/courses/686/quizzes/148')).toEqual({
      screen: screenID('/courses/:courseID/quizzes/:quizID'),
      passProps: { courseID: '686', quizID: '148' },
    })
  })
})
