...
export function registerScreens (store: Store): void {
  ...
  registerScreen('/courses/:courseID/discussion_topics', wrap(DiscussionsList), store, { canBecomeMaster: true, deepLink: true })
  registerScreen('/courses/:courseID/discussion_topics/new', wrap(DiscussionEdit), store)
  registerScreen('/courses/:courseID/discussion_topics/:discussionID', wrap(DiscussionDetails), store, { deepLink: true })
  ...
  registerScreen('/courses/:courseID/discussion_topics/:discussionID/entries/:entryID/replies', wrap(EditReply), store, { deepLink: true })
  ...
  registerScreen('/courses/:courseID/announcements', wrap(AnnouncementsList), store, { canBecomeMaster: true, deepLink: true })
  registerScreen('/courses/:courseID/announcements/new', wrap(AnnouncementEdit), store)
  registerScreen('/courses/:courseID/announcements/:announcementID', wrap(DiscussionDetails), store, { deepLink: true })
