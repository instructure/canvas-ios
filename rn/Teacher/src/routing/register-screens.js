...
export function registerScreens (store: Store): void {
  ...
  registerScreen('/courses/:courseID/assignments/collaborations', null, store, { showInWebView: true, deepLink: true })
  registerScreen('/courses/:courseID/assignments/lti_collaborations', null, store, { showInWebView: true, deepLink: true })
