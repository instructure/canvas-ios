...
export function getCourses (): ApiPromise<Course[]> {
  ...
  const courses = paginate('courses', {
    params: {
      include: [ 'course_image', 'current_grading_period_scores', 'favorites', 'needs_grading_count', 'observed_users', 'permissions', 'sections', 'syllabus_body', 'tabs', 'term', 'total_scores' ],
      state,
      per_page: 10,
    },
  })
