...
class ActivityStreamViewControllerTests: StudentTestCase {
    ...
    func testLayout() {
        ...
        XCTAssertEqual(cell?.courseCode.textColor.difference(to: UIColor(hexString: "#f00")!.ensureContrast()), 0)
        ...
        XCTAssertEqual(cell?.courseCode.textColor.difference(to: UIColor(hexString: "#0f0")!.ensureContrast()), 0)
