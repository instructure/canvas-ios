...
public class QuizzesHelper: BaseHelper {
    @discardableResult
    public static func createQuiz(course: DSCourse, title: String, description: String, quiz_type: DSQuizType, published: Bool = true) throws -> DSQuiz {
    ...
    @discardableResult
    public static func createQuizQuestion(course: DSCourse, quiz: DSQuiz, name: String, type: DSQuestionType, text: String, answers: [DSAnswer]) throws -> DSQuizQuestion {
    ...
    @discardableResult
    public static func createTestQuizQuestion(course: DSCourse, quiz: DSQuiz) throws -> DSQuizQuestion {
        ...
        return try createQuizQuestion(course: course, quiz: quiz, name: name, type: type, text: text, answers: answers)
    }
}
