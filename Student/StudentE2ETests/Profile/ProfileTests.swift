...
class ProfileTests: E2ETestCase {
    func testProfile() {
        ...
        let networkButton = ProfileHelper.networkButton.waitUntil(.vanish)
        let developerButton = ProfileHelper.developerMenuButton.waitUntil(.vanish)
        ...
        XCTAssertNotVisible(networkButton)
        XCTAssertNotVisible(developerButton)
