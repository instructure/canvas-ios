...
class PeopleTests: E2ETestCase {
    func testPeopleListAndContextCard() {
        ...
        let person1 = PeopleHelper.peopleCell(index: 0).waitUntil(condition: .visible)
        XCTAssertTrue(person1.isVisible)
        let person1RoleLabel = PeopleHelper.roleLabelOfPeopleCell(index: 0).waitUntil(condition: .visible)
        XCTAssertTrue(person1RoleLabel.isVisible)
        XCTAssertEqual(person1RoleLabel.label, "Student")
        let person1NameLabel = PeopleHelper.nameLabelOfPeopleCell(index: 0).waitUntil(condition: .visible)
        XCTAssertTrue(person1NameLabel.isVisible)
        XCTAssertEqual(person1NameLabel.label, students[0].name)

        let person2 = PeopleHelper.peopleCell(index: 1).waitUntil(condition: .visible)
        XCTAssertTrue(person2.isVisible)
        let person2RoleLabel = PeopleHelper.roleLabelOfPeopleCell(index: 1).waitUntil(condition: .visible)
        XCTAssertTrue(person2RoleLabel.isVisible)
        XCTAssertEqual(person2RoleLabel.label, "Student")
        let person2NameLabel = PeopleHelper.nameLabelOfPeopleCell(index: 1).waitUntil(condition: .visible)
        XCTAssertTrue(person2NameLabel.isVisible)
        XCTAssertEqual(person2NameLabel.label, students[1].name)

        let person3 = PeopleHelper.peopleCell(index: 2).waitUntil(condition: .visible)
        XCTAssertTrue(person3.isVisible)
        let person3RoleLabel = PeopleHelper.roleLabelOfPeopleCell(index: 2).waitUntil(condition: .visible)
        XCTAssertTrue(person3RoleLabel.isVisible)
        XCTAssertEqual(person3RoleLabel.label, "Student")
        let person3NameLabel = PeopleHelper.nameLabelOfPeopleCell(index: 2).waitUntil(condition: .visible)
        XCTAssertTrue(person3NameLabel.isVisible)
        XCTAssertEqual(person3NameLabel.label, students[2].name)

        let person4 = PeopleHelper.peopleCell(index: 3).waitUntil(condition: .visible)
        XCTAssertTrue(person4.isVisible)
        let person4RoleLabel = PeopleHelper.roleLabelOfPeopleCell(index: 3).waitUntil(condition: .visible)
        XCTAssertTrue(person4RoleLabel.isVisible)
        XCTAssertEqual(person4RoleLabel.label, "Teacher")
        let person4NameLabel = PeopleHelper.nameLabelOfPeopleCell(index: 3).waitUntil(condition: .visible)
        XCTAssertTrue(person4NameLabel.isVisible)
        XCTAssertEqual(person4NameLabel.label, teachers[0].name)

        let person5 = PeopleHelper.peopleCell(index: 4).waitUntil(condition: .visible)
        XCTAssertTrue(person5.isVisible)
        let person5RoleLabel = PeopleHelper.roleLabelOfPeopleCell(index: 4).waitUntil(condition: .visible)
        XCTAssertTrue(person5RoleLabel.isVisible)
        XCTAssertEqual(person5RoleLabel.label, "Teacher")
        let person5NameLabel = PeopleHelper.nameLabelOfPeopleCell(index: 4).waitUntil(condition: .visible)
        ...
        let courseLabel = PeopleHelper.ContextCard.courseLabel.waitUntil(condition: .visible)
        XCTAssertTrue(courseLabel.isVisible)
        XCTAssertEqual(courseLabel.label, course.name)

        let sectionLabel = PeopleHelper.ContextCard.sectionLabel.waitUntil(condition: .visible)
    ...
    func testPeopleListUpdatesAfterEnrollmentOfPersonIsDeleted() {
        ...
        var person2 = PeopleHelper.peopleCell(index: 1).waitUntil(condition: .visible)
        XCTAssertTrue(person2.isVisible)
        let person2RoleLabel = PeopleHelper.roleLabelOfPeopleCell(index: 1).waitUntil(condition: .visible)
        XCTAssertTrue(person2RoleLabel.isVisible)
        XCTAssertEqual(person2RoleLabel.label, "Student")
        ...
        person2 = PeopleHelper.peopleCell(index: 1).waitUntil(condition: .visible)
