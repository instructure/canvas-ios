...
class ConferencesTests: E2ETestCase {
    ...
    func testConferences() {
        ...
        XCTAssertVisible(newConferencesHeader)
        ...
        XCTAssertVisible(conferenceTitle)
        XCTAssertVisible(conferenceStatus)
        XCTAssertVisible(conferenceDetails)
        ...
        XCTAssertVisible(detailsTitle)
        XCTAssertVisible(detailsStatus)
        XCTAssertVisible(detailsDetails)
