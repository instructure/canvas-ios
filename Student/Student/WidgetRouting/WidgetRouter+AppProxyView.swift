...
extension WidgetRouter.AppViewProxy {

    var tabController: UITabBarController? {
        rootViewController as? UITabBarController
    }

    var selectedTabController: UIViewController? { tabController?.selectedViewController }

    var selectedTabSplitController: UISplitViewController? {
        selectedTabController as? UISplitViewController
    }
    ...
    var selectedTabNavigationController: UINavigationController? {
    ...
    func resetNavigationToRoot(animated: Bool = false) {
        (selectedTabNavigationController ?? rootNavigationController)?
