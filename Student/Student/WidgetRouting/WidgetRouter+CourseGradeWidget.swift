...
extension WidgetRouter {
    ...
    static func createCourseGradeRouter() -> WidgetRouter {
        WidgetRouter(originValue: "course-grade-widget", handlers: [
    ...
    private static var courseGradesTabHandler: RouteHandler {
        .init("/courses/:courseID/grades", action: { url, params, view in
            Analytics.shared.logEvent(CourseGradeWidgetEventNames.openGrades.rawValue)
