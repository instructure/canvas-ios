...
open class Dispatcher<Input, Output, E: Error> {
	...
	fileprivate let eventsObserver: Signal<Signal<Output, E>.Event, Never>.Observer
    ...
    public let events: Signal<Signal<Output, E>.Event, Never>
    ...
    public let errors: Signal<E, Never>

	public init(execute: @escaping (Input) -> SignalProducer<Output, E>) {
        executeClosure = execute
		(events, eventsObserver) = Signal<Signal<Output, E>.Event, Never>.pipe()
