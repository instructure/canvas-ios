...
4. Writes the resolved token values into the versioned JSON files under `Resources/Tokens-{version}/Semantic/`.
...
3. Commit the regenerated `Generated/*.swift` files and the new `Resources/Tokens-{version}/` directory.
