...
///
/// @return `YES` if generation was successful, `NO` otherwise.
+ (BOOL)generatePDFFromConfiguration:(PSPDFProcessorConfiguration *)configuration saveOptions:(nullable PSPDFProcessorSaveOptions *)saveOptions outputDataSink:(id<PSPDFDataSink>)outputDataSink progressBlock:(nullable PSPDFProgressBlock)progressBlock error:(NSError *__autoreleasing*)error;
