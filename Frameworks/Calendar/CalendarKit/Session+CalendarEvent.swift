...
let calendarKitDBFailedToLoadErrorDescription = NSLocalizedString("There was a problem loading the CalendarKit database file.", comment: "CalendarKit Database Load Failure Message")
