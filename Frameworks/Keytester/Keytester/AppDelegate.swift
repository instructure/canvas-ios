...
let baseURL = URL(string: "https://mobile-1-canvas.portal2.canvaslms.com")!
...
class AppDelegate: UIResponder, UIApplicationDelegate, SelectDomainDataSource {
    ...
    var tintTopColor: UIColor = UIColor.blue
    var tintBottomColor: UIColor = UIColor.green

    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        window = UIWindow(frame: UIScreen.main.bounds)

        let loginVC = LoginViewController.new(baseURL, clientID: clientID, clientSecret: clientSecret)
