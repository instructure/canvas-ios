...
class CanvasQuizService: QuizService {
    ...
    func completeSubmissionRequest(_ submission: Submission) -> Request<Submission> {
...
private func extractSubmissions(_ json: Any?) -> Result<[Submission], NSError> {
...
private func extractFirstSubmission(_ json: Any?) -> Result<Submission, NSError> {
