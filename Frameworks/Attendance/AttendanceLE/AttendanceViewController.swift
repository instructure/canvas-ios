...
open class AttendanceViewController: UIViewController {
    ...
    open override func viewDidLoad() {
        ...
        let datePickerButton = UIBarButtonItem(image: UIImage(named: "calendar", in: Bundle.AttendanceLE, compatibleWith: nil), style: .plain, target: self, action: #selector(showDatePicker(_:)))
